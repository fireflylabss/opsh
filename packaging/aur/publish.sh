...
echo "==> publishing opsh $VER to AUR"
...
if git diff --cached --quiet; then
  ...
  git commit -m "opsh ${VER}"
fi

echo "==> pushing to AUR…"
git push -u origin HEAD:master
echo "==> done → https://aur.archlinux.org/packages/opsh"
